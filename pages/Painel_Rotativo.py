...
# Tempos de ecrã (O ciclo completo de voz leva cerca de 50 segundos)
if st.session_state.idx == 0: espera = 55 
else: espera = 20 

tempo_passado = time.time() - st.session_state.last_time

# === MOTOR DE TRANSIÇÃO (Sempre que muda de ecrã, volta a falar) ===
    ...
    if st.session_state.idx == 0: 
        ...
        with st.container():
            ...
            if os.path.exists("rota_sincronizada.csv"):
                ...
                com_audio_str = "true" if st.session_state.falar else "false"
