        ...
        if os.path.exists(ARQUIVO_ROTA_DISCO):
            ...
            if col_status_real:
                ...
                if permitir_audio_tec1:
                    ...
                    delay_atual = 0
                    script_cenario += f"anunciarBase('{frase_incisiva_tec1} Total de O.Os: {total_pendentes} pendentes, {total_em_rota} em rota e {total_iniciados} iniciados.', {delay_atual});\n"
                    delay_atual += 24000
...
# Tempo estendido para o TEC1 discursar com tranquilidade
