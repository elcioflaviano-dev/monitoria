...
st.markdown("""<style>
    ...
    .box-base-sp { background: #dcf7f5; border-left: 10px solid #64ede3; padding: 15px 10px; text-align: center; border-radius: 8px; box-shadow: 2px 2px 8px rgba(0,0,0,0.15); margin-bottom: 10px; }
