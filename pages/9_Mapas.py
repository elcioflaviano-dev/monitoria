...
# Marcos Roberto adicionado para manter a integridade da lista
SUPERVISORES_ORDENADOS = ["EDSON MARCO", "MAICON", "MARCOS ROBERTO", "NELSON"]
...
def cor_sup_rgb(sup):
    ...
    if sup == "MARCOS ROBERTO": return [255, 140, 0] # Laranja
    return [0, 0, 0]
...
if os.path.exists(ARQUIVO_ROTA_DISCO):
    ...
    if col_sup and col_x and col_y:
        ...
        if "EDSON MARCO" in visao_selecionada: df_mapa = df_mapa[df_mapa['SUPERVISOR_CLEAN'] == "EDSON MARCO"]
        elif "MAICON" in visao_selecionada: df_mapa = df_mapa[df_mapa['SUPERVISOR_CLEAN'] == "MAICON"]
        elif "MARCOS ROBERTO" in visao_selecionada: df_mapa = df_mapa[df_mapa['SUPERVISOR_CLEAN'] == "MARCOS ROBERTO"]
        elif "NELSON" in visao_selecionada: df_mapa = df_mapa[df_mapa['SUPERVISOR_CLEAN'] == "NELSON"]
        ...
        if not df_mapa.empty:
            ...
            if "GERAL" in visao_selecionada:
                ...
                <div style="{base_style}">
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;"><span style="display:inline-block; width: 20px; height: 20px; background-color: #FFA500; border-radius: 50%; border: 1px solid #000;"></span> MARCOS ROBERTO</div>
            ...
            elif "MARCOS" in visao_selecionada:
                legenda_html = f'<div style="{base_style}"><div style="display: flex; align-items: center; gap: 8px;"><span style="display:inline-block; width: 20px; height: 20px; background-color: #FFA500; border-radius: 50%; border: 1px solid #000;"></span> MARCOS ROBERTO</div></div>'
            else:
